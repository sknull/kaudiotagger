...
enum class ID3v22FieldKey(
    val frameId: ID3v22Frames,
    val fieldName: String? = null,
    val fieldType: Id3FieldType,
    var subId: String? = null
): FieldKey {
    ACOUSTID_FINGERPRINT(
        ID3v22Frames.USER_DEFINED_INFO,
    ...
    ALBUM(ID3v22Frames.ALBUM, fieldType = Id3FieldType.TEXT),
    ALBUM_ARTIST(ID3v22Frames.ACCOMPANIMENT, fieldType = Id3FieldType.TEXT),
    ALBUM_ARTIST_SORT(ID3v22Frames.ALBUM_ARTIST_SORT_ORDER_ITUNES, fieldType = Id3FieldType.TEXT),
    ALBUM_ARTISTS(
        ID3v22Frames.USER_DEFINED_INFO,
    ...
    ALBUM_SORT(
        ID3v22Frames.ALBUM_SORT_ORDER_ITUNES,
    ...
    ARTIST(ID3v22Frames.ARTIST, fieldType = Id3FieldType.TEXT),
    ARTISTS(
        ID3v22Frames.USER_DEFINED_INFO,
    ...
    ARTIST_SORT(
        ID3v22Frames.ARTIST_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    BARCODE(
        ID3v22Frames.USER_DEFINED_INFO,
    ...
    BPM(ID3v22Frames.BPM, fieldType = Id3FieldType.TEXT),
    CATALOG_NO(
        ID3v22Frames.USER_DEFINED_INFO,
    ...
    COMMENT(ID3v22Frames.COMMENT, fieldType = Id3FieldType.TEXT),
    COMPOSER(ID3v22Frames.COMPOSER, fieldType = Id3FieldType.TEXT),
    COMPOSER_SORT(
        ID3v22Frames.COMPOSER_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    CONDUCTOR(ID3v22Frames.CONDUCTOR, fieldType = Id3FieldType.TEXT),
    CONDUCTOR_SORT(
        ID3v22Frames.USER_DEFINED_INFO,
    ...
    COVER_ART(ID3v22Frames.ATTACHED_PICTURE, fieldType = Id3FieldType.BINARY),
    CUSTOM1(
        ID3v22Frames.COMMENT,
    ...
    DISC_NO(ID3v22Frames.SET, fieldType = Id3FieldType.TEXT),
    DISC_SUBTITLE(ID3v22Frames.SET_SUBTITLE, fieldType = Id3FieldType.TEXT),
    DISC_TOTAL(ID3v22Frames.SET, fieldType = Id3FieldType.TEXT),
    DJMIXER(
        ID3v22Frames.IPLS,
        StandardIPLSKey.DJMIXER.key,
        Id3FieldType.TEXT
    ),
    ENCODER(ID3v22Frames.ENCODEDBY, fieldType = Id3FieldType.TEXT),
    ENGINEER(
        ID3v22Frames.IPLS,
    ...
    GENRE(ID3v22Frames.GENRE, fieldType = Id3FieldType.TEXT),
    GROUPING(ID3v22Frames.CONTENT_GROUP_DESC, fieldType = Id3FieldType.TEXT),
    MOOD_INSTRUMENTAL(
        ID3v22Frames.USER_DEFINED_INFO,
        FrameBodyTXXX.MOOD_INSTRUMENTAL,
        Id3FieldType.TEXT
    ),
    INVOLVED_PERSON(ID3v22Frames.IPLS, fieldType = Id3FieldType.TEXT),
    ISRC(ID3v22Frames.ISRC, fieldType = Id3FieldType.TEXT),
    IS_CLASSICAL(
        ID3v22Frames.USER_DEFINED_INFO,
        FrameBodyTXXX.IS_CLASSICAL,
        Id3FieldType.TEXT
    ),
    IS_COMPILATION(ID3v22Frames.IS_COMPILATION, fieldType = Id3FieldType.TEXT),
    IS_SOUNDTRACK(
        ID3v22Frames.USER_DEFINED_INFO,
        FrameBodyTXXX.IS_SOUNDTRACK,
        Id3FieldType.TEXT
    ),
    ITUNES_GROUPING(ID3v22Frames.ITUNES_GROUPING, fieldType = Id3FieldType.TEXT),
    KEY(ID3v22Frames.INITIAL_KEY, fieldType = Id3FieldType.TEXT),
    LANGUAGE(ID3v22Frames.LANGUAGE, fieldType = Id3FieldType.TEXT),
    LYRICIST(ID3v22Frames.LYRICIST, fieldType = Id3FieldType.TEXT),
    LYRICS(ID3v22Frames.UNSYNC_LYRICS, fieldType = Id3FieldType.TEXT),
    MEDIA(ID3v22Frames.MEDIA_TYPE, fieldType = Id3FieldType.TEXT),
    MIXER(
        ID3v22Frames.IPLS,
    ...
    MOVEMENT(ID3v22Frames.MOVEMENT, fieldType = Id3FieldType.TEXT),
    MOVEMENT_NO(ID3v22Frames.MOVEMENT_NO, fieldType = Id3FieldType.TEXT),
    MOVEMENT_TOTAL(ID3v22Frames.MOVEMENT_NO, fieldType = Id3FieldType.TEXT),
    ...
    ORIGINAL_ALBUM(ID3v22Frames.ORIG_TITLE, fieldType = Id3FieldType.TEXT),
    ORIGINAL_ARTIST(ID3v22Frames.ORIGARTIST, fieldType = Id3FieldType.TEXT),
    ORIGINAL_LYRICIST(ID3v22Frames.ORIG_LYRICIST, fieldType = Id3FieldType.TEXT),
    ORIGINAL_YEAR(ID3v22Frames.TORY, fieldType = Id3FieldType.TEXT),
    PART(
        ID3v22Frames.USER_DEFINED_INFO,
        FrameBodyTXXX.PART,
        Id3FieldType.TEXT
    ...
    PERFORMER(ID3v22Frames.IPLS, fieldType = Id3FieldType.TEXT),
    PERFORMER_NAME(
        ID3v22Frames.USER_DEFINED_INFO,
    ...
    RATING(ID3v22Frames.POPULARIMETER, fieldType = Id3FieldType.TEXT),
    RECORD_LABEL(ID3v22Frames.PUBLISHER, fieldType = Id3FieldType.TEXT),
    REMIXER(ID3v22Frames.REMIXED, fieldType = Id3FieldType.TEXT),
    SCRIPT(
        ID3v22Frames.USER_DEFINED_INFO,
    ...
    SUBTITLE(ID3v22Frames.TITLE_REFINEMENT, fieldType = Id3FieldType.TEXT),
    TAGS(
        ID3v22Frames.USER_DEFINED_INFO,
        FrameBodyTXXX.TAGS,
        Id3FieldType.TEXT
    ...
    TITLE(ID3v22Frames.TITLE, fieldType = Id3FieldType.TEXT),
    TITLE_MOVEMENT(
        ID3v22Frames.USER_DEFINED_INFO,
    ...
    TITLE_SORT(
        ID3v22Frames.TITLE_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    TONALITY(
        ID3v22Frames.USER_DEFINED_INFO,
    ...
    TRACK(ID3v22Frames.TRACK, fieldType = Id3FieldType.TEXT),
    TRACK_TOTAL(ID3v22Frames.TRACK, fieldType = Id3FieldType.TEXT),
    URL_DISCOGS_ARTIST_SITE(
        ID3v22Frames.USER_DEFINED_URL,
    ...
    YEAR(ID3v22Frames.TYER, fieldType = Id3FieldType.TEXT)
    ;
