...
enum class ID3v22FieldKey(
    val frameId: ID3V22Frame,
    val fieldName: String? = null,
    val fieldType: Id3FieldType,
    var subId: String? = null
): FieldKey {
    ACOUSTID_FINGERPRINT(
        ID3V22Frame.USER_DEFINED_INFO,
    ...
    ALBUM(ID3V22Frame.ALBUM, fieldType = Id3FieldType.TEXT),
    ALBUM_ARTIST(ID3V22Frame.ACCOMPANIMENT, fieldType = Id3FieldType.TEXT),
    ALBUM_ARTIST_SORT(ID3V22Frame.ALBUM_ARTIST_SORT_ORDER_ITUNES, fieldType = Id3FieldType.TEXT),
    ALBUM_ARTISTS(
        ID3V22Frame.USER_DEFINED_INFO,
    ...
    ALBUM_SORT(
        ID3V22Frame.ALBUM_SORT_ORDER_ITUNES,
    ...
    ARTIST(ID3V22Frame.ARTIST, fieldType = Id3FieldType.TEXT),
    ARTISTS(
        ID3V22Frame.USER_DEFINED_INFO,
    ...
    ARTIST_SORT(
        ID3V22Frame.ARTIST_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    BARCODE(
        ID3V22Frame.USER_DEFINED_INFO,
    ...
    BPM(ID3V22Frame.BPM, fieldType = Id3FieldType.TEXT),
    CATALOG_NO(
        ID3V22Frame.USER_DEFINED_INFO,
    ...
    COMMENT(ID3V22Frame.COMMENT, fieldType = Id3FieldType.TEXT),
    COMPOSER(ID3V22Frame.COMPOSER, fieldType = Id3FieldType.TEXT),
    COMPOSER_SORT(
        ID3V22Frame.COMPOSER_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    CONDUCTOR(ID3V22Frame.CONDUCTOR, fieldType = Id3FieldType.TEXT),
    CONDUCTOR_SORT(
        ID3V22Frame.USER_DEFINED_INFO,
    ...
    COVER_ART(ID3V22Frame.ATTACHED_PICTURE, fieldType = Id3FieldType.BINARY),
    CUSTOM1(
        ID3V22Frame.COMMENT,
    ...
    DISC_NO(ID3V22Frame.SET, fieldType = Id3FieldType.TEXT),
    DISC_SUBTITLE(ID3V22Frame.SET_SUBTITLE, fieldType = Id3FieldType.TEXT),
    DISC_TOTAL(ID3V22Frame.SET, fieldType = Id3FieldType.TEXT),
    DJMIXER(
        ID3V22Frame.IPLS,
        StandardIPLSKey.DJMIXER.key,
        Id3FieldType.TEXT
    ),
    ENCODER(ID3V22Frame.ENCODEDBY, fieldType = Id3FieldType.TEXT),
    ENGINEER(
        ID3V22Frame.IPLS,
    ...
    GENRE(ID3V22Frame.GENRE, fieldType = Id3FieldType.TEXT),
    GROUPING(ID3V22Frame.CONTENT_GROUP_DESC, fieldType = Id3FieldType.TEXT),
    MOOD_INSTRUMENTAL(
        ID3V22Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.MOOD_INSTRUMENTAL,
        Id3FieldType.TEXT
    ),
    INVOLVED_PERSON(ID3V22Frame.IPLS, fieldType = Id3FieldType.TEXT),
    ISRC(ID3V22Frame.ISRC, fieldType = Id3FieldType.TEXT),
    IS_CLASSICAL(
        ID3V22Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.IS_CLASSICAL,
        Id3FieldType.TEXT
    ),
    IS_COMPILATION(ID3V22Frame.IS_COMPILATION, fieldType = Id3FieldType.TEXT),
    IS_SOUNDTRACK(
        ID3V22Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.IS_SOUNDTRACK,
        Id3FieldType.TEXT
    ),
    ITUNES_GROUPING(ID3V22Frame.ITUNES_GROUPING, fieldType = Id3FieldType.TEXT),
    KEY(ID3V22Frame.INITIAL_KEY, fieldType = Id3FieldType.TEXT),
    LANGUAGE(ID3V22Frame.LANGUAGE, fieldType = Id3FieldType.TEXT),
    LYRICIST(ID3V22Frame.LYRICIST, fieldType = Id3FieldType.TEXT),
    LYRICS(ID3V22Frame.UNSYNC_LYRICS, fieldType = Id3FieldType.TEXT),
    MEDIA(ID3V22Frame.MEDIA_TYPE, fieldType = Id3FieldType.TEXT),
    MIXER(
        ID3V22Frame.IPLS,
    ...
    MOVEMENT(ID3V22Frame.MOVEMENT, fieldType = Id3FieldType.TEXT),
    MOVEMENT_NO(ID3V22Frame.MOVEMENT_NO, fieldType = Id3FieldType.TEXT),
    MOVEMENT_TOTAL(ID3V22Frame.MOVEMENT_NO, fieldType = Id3FieldType.TEXT),
    ...
    ORIGINAL_ALBUM(ID3V22Frame.ORIG_TITLE, fieldType = Id3FieldType.TEXT),
    ORIGINAL_ARTIST(ID3V22Frame.ORIGARTIST, fieldType = Id3FieldType.TEXT),
    ORIGINAL_LYRICIST(ID3V22Frame.ORIG_LYRICIST, fieldType = Id3FieldType.TEXT),
    ORIGINAL_YEAR(ID3V22Frame.TORY, fieldType = Id3FieldType.TEXT),
    PART(
        ID3V22Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.PART,
        Id3FieldType.TEXT
    ...
    PERFORMER(ID3V22Frame.IPLS, fieldType = Id3FieldType.TEXT),
    PERFORMER_NAME(
        ID3V22Frame.USER_DEFINED_INFO,
    ...
    RATING(ID3V22Frame.POPULARIMETER, fieldType = Id3FieldType.TEXT),
    RECORD_LABEL(ID3V22Frame.PUBLISHER, fieldType = Id3FieldType.TEXT),
    REMIXER(ID3V22Frame.REMIXED, fieldType = Id3FieldType.TEXT),
    SCRIPT(
        ID3V22Frame.USER_DEFINED_INFO,
    ...
    SUBTITLE(ID3V22Frame.TITLE_REFINEMENT, fieldType = Id3FieldType.TEXT),
    TAGS(
        ID3V22Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.TAGS,
        Id3FieldType.TEXT
    ...
    TITLE(ID3V22Frame.TITLE, fieldType = Id3FieldType.TEXT),
    TITLE_MOVEMENT(
        ID3V22Frame.USER_DEFINED_INFO,
    ...
    TITLE_SORT(
        ID3V22Frame.TITLE_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    TONALITY(
        ID3V22Frame.USER_DEFINED_INFO,
    ...
    TRACK(ID3V22Frame.TRACK, fieldType = Id3FieldType.TEXT),
    TRACK_TOTAL(ID3V22Frame.TRACK, fieldType = Id3FieldType.TEXT),
    URL_DISCOGS_ARTIST_SITE(
        ID3V22Frame.USER_DEFINED_URL,
    ...
    YEAR(ID3V22Frame.TYER, fieldType = Id3FieldType.TEXT)
    ;
