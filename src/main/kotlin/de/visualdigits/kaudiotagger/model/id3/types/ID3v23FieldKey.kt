...
enum class ID3v23FieldKey(
    val frameId: ID3V23FrameId,
    val fieldName: String? = null,
    val fieldType: Id3FieldType,
    var subId: String? = null
): FieldKey {
    ACOUSTID_FINGERPRINT(
        ID3V23FrameId.USER_DEFINED_INFO,
    ...
    ALBUM(ID3V23FrameId.ALBUM, fieldType = Id3FieldType.TEXT),
    ALBUM_ARTIST(ID3V23FrameId.ACCOMPANIMENT, fieldType = Id3FieldType.TEXT),
    ALBUM_ARTIST_SORT(
        ID3V23FrameId.ALBUM_ARTIST_SORT_ORDER_ITUNES,
    ...
    ALBUM_SORT(
        ID3V23FrameId.ALBUM_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    AMAZON_ID(
        ID3V23FrameId.USER_DEFINED_INFO,
    ...
    ARTIST(ID3V23FrameId.ARTIST, fieldType = Id3FieldType.TEXT),
    ARTISTS(
        ID3V23FrameId.USER_DEFINED_INFO,
    ...
    ARTIST_SORT(
        ID3V23FrameId.ARTIST_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    BARCODE(
        ID3V23FrameId.USER_DEFINED_INFO,
    ...
    BPM(ID3V23FrameId.BPM, fieldType = Id3FieldType.TEXT),
    CATALOG_NO(
        ID3V23FrameId.USER_DEFINED_INFO,
    ...
    COMMENT(ID3V23FrameId.COMMENT, fieldType = Id3FieldType.TEXT),
    COMPOSER(ID3V23FrameId.COMPOSER, fieldType = Id3FieldType.TEXT),
    COMPOSER_SORT(
        ID3V23FrameId.COMPOSER_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    CONDUCTOR(ID3V23FrameId.CONDUCTOR, fieldType = Id3FieldType.TEXT),
    CONDUCTOR_SORT(
        ID3V23FrameId.USER_DEFINED_INFO,
    ...
    COVER_ART(ID3V23FrameId.ATTACHED_PICTURE, fieldType = Id3FieldType.BINARY),
    CUSTOM1(
        ID3V23FrameId.COMMENT,
    ...
    DISC_NO(ID3V23FrameId.SET, fieldType = Id3FieldType.TEXT),
    DISC_SUBTITLE(ID3V23FrameId.SET_SUBTITLE, fieldType = Id3FieldType.TEXT),
    DISC_TOTAL(ID3V23FrameId.SET, fieldType = Id3FieldType.TEXT),
    DJMIXER(
        ID3V23FrameId.INVOLVED_PEOPLE,
        StandardIPLSKey.DJMIXER.key,
        Id3FieldType.TEXT
    ),
    ENCODER(ID3V23FrameId.ENCODEDBY, fieldType = Id3FieldType.TEXT),
    ENGINEER(
        ID3V23FrameId.INVOLVED_PEOPLE,
    ...
    GENRE(ID3V23FrameId.GENRE, fieldType = Id3FieldType.TEXT),
    GROUPING(ID3V23FrameId.CONTENT_GROUP_DESC, fieldType = Id3FieldType.TEXT),
    INVOLVED_PERSON(ID3V23FrameId.INVOLVED_PEOPLE, fieldType = Id3FieldType.TEXT),
    ISRC(ID3V23FrameId.ISRC, fieldType = Id3FieldType.TEXT),
    IS_CLASSICAL(
        ID3V23FrameId.USER_DEFINED_INFO,
        FrameBodyTXXX.IS_CLASSICAL,
        Id3FieldType.TEXT
    ),
    IS_COMPILATION(ID3V23FrameId.IS_COMPILATION, fieldType = Id3FieldType.TEXT),
    IS_SOUNDTRACK(
        ID3V23FrameId.USER_DEFINED_INFO,
        FrameBodyTXXX.IS_SOUNDTRACK,
        Id3FieldType.TEXT
    ),
    ITUNES_GROUPING(ID3V23FrameId.ITUNES_GROUPING, fieldType = Id3FieldType.TEXT),
    KEY(ID3V23FrameId.INITIAL_KEY, fieldType = Id3FieldType.TEXT),
    LANGUAGE(ID3V23FrameId.LANGUAGE, fieldType = Id3FieldType.TEXT),
    LYRICIST(ID3V23FrameId.LYRICIST, fieldType = Id3FieldType.TEXT),
    LYRICS(ID3V23FrameId.UNSYNC_LYRICS, fieldType = Id3FieldType.TEXT),
    MEDIA(ID3V23FrameId.MEDIA_TYPE, fieldType = Id3FieldType.TEXT),
    MIXER(
        ID3V23FrameId.INVOLVED_PEOPLE,
    ...
    MOVEMENT(ID3V23FrameId.MOVEMENT, fieldType = Id3FieldType.TEXT),
    MOVEMENT_NO(ID3V23FrameId.MOVEMENT_NO, fieldType = Id3FieldType.TEXT),
    MOVEMENT_TOTAL(ID3V23FrameId.MOVEMENT_NO, fieldType = Id3FieldType.TEXT),
    ...
    ORIGINAL_ALBUM(ID3V23FrameId.ORIG_TITLE, fieldType = Id3FieldType.TEXT),
    ORIGINAL_ARTIST(ID3V23FrameId.ORIGARTIST, fieldType = Id3FieldType.TEXT),
    ORIGINAL_LYRICIST(ID3V23FrameId.ORIG_LYRICIST, fieldType = Id3FieldType.TEXT),
    ORIGINAL_YEAR(ID3V23FrameId.TORY, fieldType = Id3FieldType.TEXT),
    PART(
        ID3V23FrameId.USER_DEFINED_INFO,
        FrameBodyTXXX.PART,
        Id3FieldType.TEXT
    ...
    PERFORMER(ID3V23FrameId.INVOLVED_PEOPLE, fieldType = Id3FieldType.TEXT),
    PERFORMER_NAME(
        ID3V23FrameId.USER_DEFINED_INFO,
    ...
    RATING(ID3V23FrameId.POPULARIMETER, fieldType = Id3FieldType.TEXT),
    RECORD_LABEL(ID3V23FrameId.PUBLISHER, fieldType = Id3FieldType.TEXT),
    REMIXER(ID3V23FrameId.REMIXED, fieldType = Id3FieldType.TEXT),
    SCRIPT(
        ID3V23FrameId.USER_DEFINED_INFO,
    ...
    SUBTITLE(ID3V23FrameId.TITLE_REFINEMENT, fieldType = Id3FieldType.TEXT),
    TAGS(
        ID3V23FrameId.USER_DEFINED_INFO,
        FrameBodyTXXX.TAGS,
        Id3FieldType.TEXT
    ...
    TITLE(ID3V23FrameId.TITLE, fieldType = Id3FieldType.TEXT),
    TITLE_MOVEMENT(
        ID3V23FrameId.USER_DEFINED_INFO,
    ...
    TITLE_SORT(
        ID3V23FrameId.TITLE_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    TONALITY(
        ID3V23FrameId.USER_DEFINED_INFO,
    ...
    TRACK(ID3V23FrameId.TRACK, fieldType = Id3FieldType.TEXT),
    TRACK_TOTAL(ID3V23FrameId.TRACK, fieldType = Id3FieldType.TEXT),
    URL_DISCOGS_ARTIST_SITE(
        ID3V23FrameId.USER_DEFINED_URL,
    ...
    YEAR(ID3V23FrameId.TYER, fieldType = Id3FieldType.TEXT)
    ;

    companion object {

        fun fromFrameId(id: String?): ID3v23FieldKey? = entries.find { e -> e.frameId.id == id }
    }
}