...
enum class ID3v24FieldKey(
    ...
    ALBUM(ID3V24Frame.ALBUM, fieldType = Id3FieldType.TEXT),
    ALBUM_ARTIST(ID3V24Frame.ACCOMPANIMENT, fieldType = Id3FieldType.TEXT),
    ALBUM_ARTIST_SORT(
        ID3V24Frame.ALBUM_ARTIST_SORT_ORDER_ITUNES,
    ...
    ALBUM_SORT(ID3V24Frame.ALBUM_SORT_ORDER, fieldType = Id3FieldType.TEXT),
    AMAZON_ID(
        ID3V24Frame.USER_DEFINED_INFO,
    ...
    ARTIST(ID3V24Frame.ARTIST, fieldType = Id3FieldType.TEXT),
    ARTISTS(
        ID3V24Frame.USER_DEFINED_INFO,
    ...
    ARTIST_SORT(ID3V24Frame.ARTIST_SORT_ORDER, fieldType = Id3FieldType.TEXT),
    BARCODE(
        ID3V24Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.BARCODE,
        Id3FieldType.TEXT
    ),
    BPM(ID3V24Frame.BPM, fieldType = Id3FieldType.TEXT),
    CATALOG_NO(
        ID3V24Frame.USER_DEFINED_INFO,
    ...
    COMMENT(ID3V24Frame.COMMENT, fieldType = Id3FieldType.TEXT),
    COMPOSER(ID3V24Frame.COMPOSER, fieldType = Id3FieldType.TEXT),
    COMPOSER_SORT(
        ID3V24Frame.COMPOSER_SORT_ORDER_ITUNES,
        fieldType = Id3FieldType.TEXT
    ),
    CONDUCTOR(ID3V24Frame.CONDUCTOR, fieldType = Id3FieldType.TEXT),
    CONDUCTOR_SORT(
        ID3V24Frame.USER_DEFINED_INFO,
    ...
    COVER_ART(ID3V24Frame.ATTACHED_PICTURE, fieldType = Id3FieldType.BINARY),
    CUSTOM1(
        ID3V24Frame.COMMENT,
    ...
    DISC_NO(ID3V24Frame.SET, fieldType = Id3FieldType.TEXT),
    DISC_SUBTITLE(ID3V24Frame.SET_SUBTITLE, fieldType = Id3FieldType.TEXT),
    DISC_TOTAL(ID3V24Frame.SET, fieldType = Id3FieldType.TEXT),
    DJMIXER(
        ID3V24Frame.INVOLVED_PEOPLE,
        StandardIPLSKey.DJMIXER.key,
        Id3FieldType.TEXT
    ),
    ENCODER(ID3V24Frame.ENCODEDBY, fieldType = Id3FieldType.TEXT),
    ENGINEER(
        ID3V24Frame.INVOLVED_PEOPLE,
    ...
    GENRE(ID3V24Frame.GENRE, fieldType = Id3FieldType.TEXT),
    GROUPING(ID3V24Frame.CONTENT_GROUP_DESC, fieldType = Id3FieldType.TEXT),
    INVOLVED_PERSON(ID3V24Frame.INVOLVED_PEOPLE, fieldType = Id3FieldType.TEXT),
    ISRC(ID3V24Frame.ISRC, fieldType = Id3FieldType.TEXT),
    IS_CLASSICAL(
        ID3V24Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.IS_CLASSICAL,
        Id3FieldType.TEXT
    ),
    IS_COMPILATION(ID3V24Frame.IS_COMPILATION, fieldType = Id3FieldType.TEXT),
    IS_SOUNDTRACK(
        ID3V24Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.IS_SOUNDTRACK,
        Id3FieldType.TEXT
    ),
    ITUNES_GROUPING(ID3V24Frame.ITUNES_GROUPING, fieldType = Id3FieldType.TEXT),
    KEY(ID3V24Frame.INITIAL_KEY, fieldType = Id3FieldType.TEXT),
    LANGUAGE(ID3V24Frame.LANGUAGE, fieldType = Id3FieldType.TEXT),
    LYRICIST(ID3V24Frame.LYRICIST, fieldType = Id3FieldType.TEXT),
    LYRICS(ID3V24Frame.UNSYNC_LYRICS, fieldType = Id3FieldType.TEXT),
    MEDIA(ID3V24Frame.MEDIA_TYPE, fieldType = Id3FieldType.TEXT),
    MIXER(
        ID3V24Frame.INVOLVED_PEOPLE,
        StandardIPLSKey.MIXER.key,
        Id3FieldType.TEXT
    ),
    MOOD(ID3V24Frame.MOOD, fieldType = Id3FieldType.TEXT),
    MOOD_ACOUSTIC(
        ID3V24Frame.USER_DEFINED_INFO,
    ...
    MOVEMENT(ID3V24Frame.MOVEMENT, fieldType = Id3FieldType.TEXT),
    MOVEMENT_NO(ID3V24Frame.MOVEMENT_NO, fieldType = Id3FieldType.TEXT),
    MOVEMENT_TOTAL(ID3V24Frame.MOVEMENT_NO, fieldType = Id3FieldType.TEXT),
    ...
    ORIGINAL_ALBUM(ID3V24Frame.ORIG_TITLE, fieldType = Id3FieldType.TEXT),
    ORIGINAL_ARTIST(ID3V24Frame.ORIGARTIST, fieldType = Id3FieldType.TEXT),
    ORIGINAL_LYRICIST(ID3V24Frame.ORIG_LYRICIST, fieldType = Id3FieldType.TEXT),
    ORIGINAL_YEAR(ID3V24Frame.ORIGINAL_RELEASE_TIME, fieldType = Id3FieldType.TEXT),
    PART(
        ID3V24Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.PART,
        Id3FieldType.TEXT
    ...
    PERFORMER(ID3V24Frame.MUSICIAN_CREDITS, fieldType = Id3FieldType.TEXT),
    PERFORMER_NAME(
        ID3V24Frame.USER_DEFINED_INFO,
    ...
    RATING(ID3V24Frame.POPULARIMETER, fieldType = Id3FieldType.TEXT),
    RECORD_LABEL(ID3V24Frame.PUBLISHER, fieldType = Id3FieldType.TEXT),
    REMIXER(ID3V24Frame.REMIXED, fieldType = Id3FieldType.TEXT),
    SCRIPT(
        ID3V24Frame.USER_DEFINED_INFO,
    ...
    SUBTITLE(ID3V24Frame.TITLE_REFINEMENT, fieldType = Id3FieldType.TEXT),
    TAGS(
        ID3V24Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.TAGS,
        Id3FieldType.TEXT
    ...
    TITLE(ID3V24Frame.TITLE, fieldType = Id3FieldType.TEXT),
    TITLE_MOVEMENT(
        ID3V24Frame.USER_DEFINED_INFO,
    ...
    TITLE_SORT(ID3V24Frame.TITLE_SORT_ORDER, fieldType = Id3FieldType.TEXT),
    TONALITY(
        ID3V24Frame.USER_DEFINED_INFO,
        FrameBodyTXXX.TONALITY,
        Id3FieldType.TEXT
    ),
    TRACK(ID3V24Frame.TRACK, fieldType = Id3FieldType.TEXT),
    TRACK_TOTAL(ID3V24Frame.TRACK, fieldType = Id3FieldType.TEXT),
    URL_DISCOGS_ARTIST_SITE(
        ID3V24Frame.USER_DEFINED_URL,
    ...
    YEAR(ID3V24Frame.YEAR, fieldType = Id3FieldType.TEXT)
    ;
