...
class FrameTSO2Test : AbstractTestCase() {
    @Test
    fun testCreateID3v24Frame() {
        ...
        assertEquals(
            ...
            (frame.frameBody as FrameBodyTSO2).getText()
        )
    }
    ...
    fun testSaveToFile() {
        ...
        val frame =  mp3File
            .getID3v2Tag()
            ?.getFrame(ID3v24FrameId.ALBUM_ARTIST_SORT_ORDER_ITUNES.id) as ID3v24Frame
        val body =  frame.frameBody as FrameBodyTSO2
    ...
    fun testConvertV24ToV23() {
        ...
        val frame =  mp3File
            .getID3v2Tag()
            ?.getFrame(ID3v23FrameId.ALBUM_ARTIST_SORT_ORDER_ITUNES.id) as ID3v23Frame
        val body =  frame.frameBody as FrameBodyTSO2
        assertEquals(TextEncoding.ISO_8859_1.id, body.getTextEncoding())
    ...
    fun testConvertV24ToV22() {
        ...
        val frame =  mp3File
            .getID3v2Tag()
            ?.getFrame(ID3v22FrameId.ALBUM_ARTIST_SORT_ORDER_ITUNES.id) as ID3v22Frame
        val body =  frame.frameBody as FrameBodyTSO2
        assertEquals(TextEncoding.ISO_8859_1.id, body.getTextEncoding())
        assertEquals(FrameBodyTSO2Test.ALBUM_ARTIST_SORT, body.getText())
    }
    ...
    fun testConvertV22ToV24() {
        ...
        val id3v22frame =  ID3v22Frame(ID3v22FrameId.ALBUM_ARTIST_SORT_ORDER_ITUNES.id)
        (id3v22frame.frameBody as FrameBodyTSO2).setText(FrameBodyTSO2Test.ALBUM_ARTIST_SORT)
    ...
    companion object {
        val v24InitialisedFrame: ID3v24Frame
            get() {
                val frame =  ID3v24Frame(ID3v24FrameId.ALBUM_ARTIST_SORT_ORDER_ITUNES.id)
                val fb =  FrameBodyTSO2Test.getInitialisedBody()
                frame.frameBody = fb
                return frame
            }
        ...
        val v23InitialisedFrame: ID3v23Frame
            get() {
                val frame =  ID3v23Frame(ID3v23FrameId.ALBUM_ARTIST_SORT_ORDER_ITUNES.id)
                val fb =  FrameBodyTSO2Test.getInitialisedBody()
                frame.frameBody = fb
                return frame
            }
        ...
        val v22InitialisedFrame: ID3v22Frame
            get() {
                val frame =  ID3v22Frame(ID3v22FrameId.ALBUM_ARTIST_SORT_ORDER_ITUNES.id)
                val fb =  FrameBodyTSO2Test.getInitialisedBody()
                frame.frameBody = fb
                return frame
            }
