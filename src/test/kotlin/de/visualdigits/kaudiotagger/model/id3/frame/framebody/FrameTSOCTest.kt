...
class FrameTSOCTest : AbstractTestCase() {
    @Test
    ...
    fun testConvertV22ToV24() {
        ...
        (id3v22frame.frameBody as FrameBodyTSOC).setText(FrameBodyTSOCTest.COMPOSER_SORT)
    ...
    companion object {
        val v24InitialisedFrame: ID3v24Frame
            get() {
                ...
                val fb =  FrameBodyTSOCTest.getInitialisedBody()
                frame.frameBody = fb
                return frame
            }
