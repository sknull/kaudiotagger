...
class FrameTSOPTest : AbstractTestCase() {
    @Test
    fun testCreateID3v24Frame() {
        val frame = ID3v24Frame(ID3v24FrameId.ARTIST_SORT_ORDER.id)
        val fb = FrameBodyTSOPTest.getInitialisedBody()
        frame.frameBody = fb
    ...
    fun testCreateID3v23ITunesFrame() {
        val frame = ID3v23Frame(ID3v23FrameId.ARTIST_SORT_ORDER_ITUNES.id)
        val fb = FrameBodyTSOPTest.getInitialisedBody()
        frame.frameBody = fb
    ...
    fun testCreateID3v23MusicBrainzFrame() {
        val frame = ID3v23Frame(ID3v23FrameId.ARTIST_SORT_ORDER_MUSICBRAINZ.id)
        val fb = FrameBodyXSOPTest.getInitialisedBody()
        frame.frameBody = fb
    ...
    fun testCreateID3v22Frame() {
        val frame = ID3v22Frame(ID3v22FrameId.ARTIST_SORT_ORDER_ITUNES.id)
        val fb = FrameBodyTSOPTest.getInitialisedBody()
        frame.frameBody = fb
    ...
    fun testSaveToFile() {
        ...
        val frame =  mp3File
            .getID3v2Tag()
            ?.getFrame(ID3v24FrameId.ARTIST_SORT_ORDER.id) as ID3v24Frame
        val body =  frame.frameBody as FrameBodyTSOP
    ...
    fun testConvertV24ToV23() {
        ...
        val frame =  mp3File
            .getID3v2Tag()
            ?.getFrame(ID3v23FrameId.ARTIST_SORT_ORDER_ITUNES.id) as ID3v23Frame
        val body =  frame.frameBody as FrameBodyTSOP
        assertEquals(TextEncoding.ISO_8859_1.id, body.getTextEncoding())
    ...
    fun testConvertV24ToV22() {
        ...
        val frame =  mp3File
            .getID3v2Tag()
            ?.getFrame(ID3v22FrameId.ARTIST_SORT_ORDER_ITUNES.id) as ID3v22Frame
        val body =  frame.frameBody as FrameBodyTSOP
        assertEquals(TextEncoding.ISO_8859_1.id, body.getTextEncoding())
        assertEquals(FrameBodyTSOPTest.ARTIST_SORT, body.getText())
    }
    ...
    fun testConvertV22ToV24() {
        ...
        (id3v22frame.frameBody as FrameBodyTSOP).setText(
