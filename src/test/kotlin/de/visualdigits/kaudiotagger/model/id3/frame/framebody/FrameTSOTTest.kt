...
class FrameTSOTTest : AbstractTestCase() {
    @Test
    fun testCreateID3v24Frame() {
        val frame = ID3v24Frame(ID3v24FrameId.TITLE_SORT_ORDER.id)
        val fb = FrameBodyTSOTTest.getInitialisedBody()
        frame.frameBody = fb

        assertEquals(ID3v24FrameId.TITLE_SORT_ORDER.id, frame.getIdentifier())
    ...
    fun testCreateID3v23ITunesFrame() {
        val frame = ID3v23Frame(ID3v23FrameId.TITLE_SORT_ORDER_ITUNES.id)
        val fb = FrameBodyTSOTTest.getInitialisedBody()
        frame.frameBody = fb
    ...
    fun testCreateID3v23MusicBrainzFrame() {
        ...
        val fb = FrameBodyXSOTTest.getInitialisedBody()
        frame.frameBody = fb
    ...
    fun testCreateID3v22Frame() {
        val frame = ID3v22Frame(ID3v22FrameId.TITLE_SORT_ORDER_ITUNES.id)
        val fb = FrameBodyTSOTTest.getInitialisedBody()
        frame.frameBody = fb
    ...
    fun testSaveToFile() {
        ...
        val frame =  mp3File
            .getID3v2Tag()
            ?.getFrame(ID3v24FrameId.TITLE_SORT_ORDER.id) as ID3v24Frame
        val body =  frame.frameBody as FrameBodyTSOT
    ...
    fun testSaveEmptyFrameToFile() {
        ...
        var frame =  ID3v24Frame(ID3v24FrameId.TITLE_SORT_ORDER.id)
        frame.frameBody = FrameBodyTSOT()
    ...
    fun testConvertV24ToV23() {
        ...
        val frame =  mp3File
            .getID3v2Tag()
            ?.getFrame(ID3v23FrameId.TITLE_SORT_ORDER_ITUNES.id) as ID3v23Frame
        val body =  frame.frameBody as FrameBodyTSOT
        assertEquals(TextEncoding.ISO_8859_1.id, body.getTextEncoding())
    ...
    fun testConvertV24ToV22() {
        ...
        val frame =  mp3File
            .getID3v2Tag()
            ?.getFrame(ID3v22FrameId.TITLE_SORT_ORDER_ITUNES.id) as ID3v22Frame
        val body =  frame.frameBody as FrameBodyTSOT
        assertEquals(TextEncoding.ISO_8859_1.id, body.getTextEncoding())
        assertEquals(FrameBodyTSOTTest.TITLE_SORT, body.getText())
    }
    ...
    fun testConvertV22ToV24() {
        ...
        val id3v22frame =  ID3v22Frame(ID3v22FrameId.TITLE_SORT_ORDER_ITUNES.id)
        (id3v22frame.frameBody as FrameBodyTSOT).setText(
    ...
    companion object {
        ...
        fun getV23InitialisedFrame(): ID3v23Frame {
            val frame = ID3v23Frame(ID3v23FrameId.TITLE_SORT_ORDER_MUSICBRAINZ.id)
            val fb = FrameBodyXSOTTest.getInitialisedBody()
            frame.frameBody = fb
            return frame
        }
