...
class FrameTXXXTest : AbstractTestCase() {
    ...
    fun testConvertV22ToV24() {
        ...
        (id3v22frame.frameBody as FrameBodyTXXX).setText(FrameBodyTXXXTest.TXXX_TEST_STRING)
